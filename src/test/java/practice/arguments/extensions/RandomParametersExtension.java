// 公式サンプル集にある拡張サンプルクラスのコメント追加版
// https://github.com/junit-team/junit5-samples/blob/r5.2.0/junit5-jupiter-extensions/src/main/java/com/example/random/RandomParametersExtension.java
...
public class RandomParametersExtension implements ParameterResolver {
    ...
    public boolean supportsParameter(ParameterContext parameterContext, ExtensionContext extensionContext) {
        // 引数がサポート対象のものかを判定する
        // ここではRandomアノテーションが付与されているパラメータが対象になる
    ...
    private Object getRandomValue(Parameter parameter, ExtensionContext extensionContext) {
        ...
        // 同じRandomインスタンスを使うため、無ければ作成して保持、有れば取得、といったことをしている
        var random = extensionContext.getRoot().getStore(Namespace.GLOBAL)
